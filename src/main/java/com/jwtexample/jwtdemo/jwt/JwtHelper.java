...
public class JwtHelper {
    ...
    // THIS IS UPDATED METHOD
    //for retrieving any information from token we will need the secret key
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parserBuilder()  // Use parserBuilder() instead of parser()
                   .setSigningKey(Keys.hmacShaKeyFor(secret.getBytes())) // Convert String to bytes
                   .build()           // You need to build the parser now
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor(secret.getBytes()), SignatureAlgorithm.HS512)  // Correct way to use signWith
                .compact();
    }
